...
export function GameCanvas() {
  ...
  const scene = useMemo(() => {
    ...
    return {
      width: Math.ceil(finalBounds.maxX - finalBounds.minX + CANVAS_PADDING * 2),
      height: Math.ceil(finalBounds.maxY - finalBounds.minY + CANVAS_PADDING * 2),
      worldMatrices,
    }
  }, [angles, layers])
