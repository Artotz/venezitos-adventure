...
export const PHASE1_MANIFESTO_MODAL: Phase1SpeechModalState = {
  ...
  body: [
    ...
    "Ao longo do percurso, voce vai usar os comandos da maquina para carregar, cavar, engraxar e ativar o 4x4 quando o terreno pedir mais tracao.",
    "Tambem vao aparecer perguntas rapidas de seguranca e operacao. Elas servem para reforcar o que cada situacao exige durante a fase.",
    "Seu objetivo e manter a maquina em movimento, acertar os comandos dentro da area certa e acumular pontos enquanto aprende como cada parte da operacao funciona.",
  ].join("\n\n"),
...
export function createQuestionIntroModal(): Phase1SpeechModalState {
  return {
    ...
    body: "Antes de seguir com a operacao, vamos fazer uma parada rapida de conferencia. Pense como um operador atento: observe a situacao, revise o procedimento e responda usando as setas.",
    continueHint: PHASE1_START_MODAL_HINT,
    mood: "neutral",
  };
}
